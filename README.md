...
### A CPG-style pre-handoff QA checklist for student-built deliverables.
...
**Student Agency Operations** · **Repo 44/50** · **No backend. No login. Client data stays local.**

[Live app](https://volta-npo.github.io/44-qa-gatekeeper/) · [Report an issue](https://github.com/volta-npo/44-qa-gatekeeper/issues) · [Volta](https://voltanpo.org)
...
**QA Gatekeeper** is a polished, local-first open-source tool from Volta's 50-project OSS division. It helps Mentors, reviewers, and student leads turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
