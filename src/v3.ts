export const v3 = {
  ...
  "capabilities": [
    "Domain-specific workbench: Cross-Track QA Queue",
    "Operational table: QA findings",
  ...
  "releaseChecklist": [
    ...
    "Pass/Fail Gate reaches production threshold",
    "Severity Load is documented with evidence",
    "Evidence Coverage has no unresolved blocker",
    "QA certificate verified",
    "Defect log verified",
    "Client acceptance checklist verified"
  ],
  "operations": [
