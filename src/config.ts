  ...
  "criteria": [
    {
      ...
      "guidance": "Implement and verify track-specific qa gates with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "guidance": "Implement and verify reviewer assignment with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "guidance": "Implement and verify blocker severity rubric with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "guidance": "Implement and verify client acceptance checklist with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "evidence-quality",
